...
async function loadFacts() {
  const res = await fetch(
    "https://fnleocefcqvfelbnkzkh.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        autherization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZubGVvY2VmY3F2ZmVsYm5remtoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTY5MjQzNjEsImV4cCI6MjAzMjUwMDM2MX0.G_DZwVHSECqBnYrY6CB6F4K5AVJVgxygq2jmVQVuYQQ",
      },
    }
  );
...
const str =
  'The current fact is "${text}". It is ${calcFactAge(2015)} years old. It is probably ${totalUpvotes > votesFalse ? "correct" : "not true"}.';
console.log(str);
*/
...
const allCategories = CATEGORIESmap((el) => el.name);
